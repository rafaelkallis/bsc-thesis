...
\tikzstyle{decision} = [diamond, text centered, aspect=2.5, draw=black, fill=green!30]
...
\frame{
    ...
    \large
    $$ u_{GC} = u_{QTP} \iff T_Q = 2 \cdot T_{GC} $$
}
\frame{
...
\frame{
    \begin{figure}
        ...
        \begin{tikzpicture}[node distance=1.2cm]
            ...
            \node (dec) [decision, below of=Qperiod, node distance=1.7cm] {$T_Q > 2 \cdot T_{GC}^*$};
