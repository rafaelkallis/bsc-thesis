...
\section{Workload Aware Property Index}
...
\begin{example}
    Consider \texttt{r15cac0dbb00-0-2} in \Cref{fig:json_simple}.
...
$isVolatile(n)$ is given a node's corresponding document.
We iterate through the revisions of property \texttt{"\_deleted"} in most-recent first fashion.
Notice that the \texttt{keySet} referred to in the Java code is, in Java's terminology, an ordered set.
