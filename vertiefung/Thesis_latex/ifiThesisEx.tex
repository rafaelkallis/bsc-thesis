...
In \ref{fig:fig:node_property}, we take a look at node \texttt{/a/c} and see how \texttt{x}'s value changes over time.
...
The \texttt{15cac0dbb00} following \texttt{r}, is an timestamp in hexadecimal encoding which represents the time during which the change was committed.
...
\section{Oak's basic Operations}
