...
\Cref{sec:update-query-ratio}, we investigate the effect of update operations per second.
...
we execute a query every $1.1$ second, we are indefferent choosing between GC
