...
and QTP. The same holds in \Cref{fig:gc_vs_qtp_real} for an update-query ratio of 25:1,
...
\begin{itemize}
    ...
    \item GC outperforms QTP under workloads with a high update-query ratio,
        ...
        %, given the circumstances of our experiment.
        %We conjecture that GC might
