...
nodes increase until GC is run, after which they are removed again. We also
observe the total number of traversed nodes to be significantly different
between the two datasets although the difference in volatile nodes is not so
big.  
