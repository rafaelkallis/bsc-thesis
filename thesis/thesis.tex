...
\subsection{Impact of workload skewness and update to query ratio}
...
Iterable<String> QueryQTP(String k, String v, String m, NodeStore store) {
    ...
    return map((DocumentNodeState n) -> relativize(indexRootPath, n.getPath()),
        ...
        filter((DocumentNodeState d) -> {
            ...
            /* bottom-up tree traversal of descendants of n */
            bottomUp(n)
    );
}
\end{minted}
 ...
 */
Iterable<DocumentNodeState> bottomUp(DocumentNodeState root) {
    return () -> {
        /* Stacks */
