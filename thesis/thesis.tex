...
\Cref{fig:upt_unprod_nodes_synthetic,fig:upt_unprod_nodes_real} is linear.
...
for checking a node's productiveness and possibly deleting it.
...
impacts the position of the equilibrium point.
If we produce more unproductive nodes during a fixed
interval, the equilibrium point might move towards the left.
Under such circumstances, if queries are faster under QTP and we increase the 
