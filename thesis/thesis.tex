...
transactions. We will revisit GC's periodicity in \Cref{sec:periodicity}, where we
...
complexity, as explained in \Cref{sec:gc}. If any descendant $n \in
...
investigate the effects periodicity has on garbage collection in \Cref{sec:periodicity}.
...
performance of QTP in \Cref{sec:qtp-queried-nodes}. Also, we conduct an
...
and 1729, respectively. \Cref{fig:dataset} shows a sample subtree for each
dataset. 
